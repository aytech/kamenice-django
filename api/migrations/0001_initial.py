# Generated by Django 3.2.4 on 2021-09-14 08:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.CharField(blank=True, choices=[('INFANT', 'Do 3 let'), ('CHILD', '3-12 let'), ('YOUNG', '12+'), ('ADULT', 'Dospělý')], error_messages={'invalid_choice': 'Choose age from the list'}, max_length=10, null=True)),
                ...
                ('email', models.EmailField(error_messages={'blank': 'E-Mail is required field', 'invalid': 'Enter valid email address', 'null': 'E-Mail is required field', 'unique': 'User with this email already exists'}, max_length=254, unique=True, validators=[django.core.validators.EmailValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.CharField(blank=True, choices=[('INFANT', 'Do 3 let'), ('CHILD', '3-12 let'), ('YOUNG', '12+'), ('ADULT', 'Dospělý')], error_messages={'invalid_choice': 'Choose age from the list'}, max_length=10, null=True)),
                ('citizenship', models.CharField(blank=True, max_length=10, null=True, validators=[kamenice_django.validators.guest.validate_citizenship])),
                ('email', models.EmailField(blank=True, error_messages={'invalid': 'Enter valid email address'}, max_length=254, null=True, validators=[django.core.validators.EmailValidator()])),
                ('gender', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female')], error_messages={'invalid_choice': 'Choose gender from the list'}, max_length=10, null=True, validators=[kamenice_django.validators.guest.validate_gender])),
                ('identity', models.CharField(blank=True, max_length=50, null=True)),
                ('name', models.CharField(error_messages={'blank': 'Name is required field', 'null': 'Name is required field'}, max_length=100)),
                ('phone_number', models.CharField(blank=True, max_length=50, null=True)),
