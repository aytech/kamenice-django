...
import { appSettings, discountSettingsOptions, pageTitle, selectedPage, userColor, userName } from "../../cache"
...
export const Settings = () => {
  ...
  const updateAddDiscountTooltip = useCallback((fieldsLength: number) => {
    if (discountSettingsOptions() !== undefined && discountSettingsOptions().length <= fieldsLength) {
  ...
  useEffect(() => {
    ...
    selectedPage("user")
    const discounts = appSettings()?.discountSettingsSet
                      ...
                      { fields.map(({ key, name, fieldKey, ...restField }) => (
                        <Space
                          ...
                          <Form.Item
                            ...
                            <Select
                              options={ discountSettingsOptions() }
                              showSearch />
                          </Form.Item>
                          <Form.Item
                            hasFeedback
